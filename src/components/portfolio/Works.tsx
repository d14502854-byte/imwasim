...
const projects = [
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1553729459-uj40ec4bgsbu?w=600&h=400&fit=crop",
    ...
    <div className="p-8 md:p-12">
      ...
      >
        <div className="flex items-center gap-4 mb-8">
          <h2 className="text-3xl font-display font-bold text-foreground">Portfolio</h2>
          ...
          {projects.map((project, i) => (
            ...
            >
              <div className="relative h-40 overflow-hidden bg-muted">
                ...
                <span className="absolute top-3 left-3 px-2.5 py-0.5 rounded-lg bg-primary/90 text-primary-foreground text-xs font-medium">
                  {project.category}
                </span>
              </div>
              <div className="p-4">
